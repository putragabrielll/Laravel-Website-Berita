			...
			<div class="card full-height">
				<div class="card-header">
					<div class="card-head-row">
                        ...
                        <a href="{{ route('penulis_artikel.create') }}" class="btn btn-primary btn-sm ml-auto">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('penulis_artikel.edit', $row->id) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                                        <form action="{{ route('penulis_artikel.destroy', $row->id) }}" method="post" class="d-inline">
                                        @csrf
                                        @method('delete')
