						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="{{ asset('uploads/' . $user->foto_profile) }}" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
									...
									<li>
										...
										<a class="dropdown-item" href="{{ route('password.index') }}">Edit Password</a>
										<div class="dropdown-divider"></div>
